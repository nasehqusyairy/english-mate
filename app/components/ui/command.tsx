  ...
  return (
    ...
    >
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          "flex bg-transparent disabled:opacity-50 py-3 rounded-md outline-hidden w-full h-10 dark:placeholder:text-muted-foreground placeholder:text-muted text-sm disabled:cursor-not-allowed",
          className
        )}
        {...props}
      />
